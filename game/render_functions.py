...
def get_names_under_mouse(mouse, entities, fov_map):
    ...
    names = [
        entity.name for entity in entities if entity.x == x and entity.y == y
...
def render_all(con, panel, entities, player, game_map, fov_map, fov_recompute,
               ...
               panel_height, panel_y, mouse, colors, game_state, constants):
...
def draw_entity(con, entity, fov_map, game_map):
    if libtcod.map_is_in_fov(fov_map, entity.x, entity.y) or (
            # draw stairs out of fov if discovered
