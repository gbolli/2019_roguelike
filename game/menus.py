...
def main_menu(con, background_image, screen_width, screen_height):
    ...
    libtcod.console_print_ex(0, int(screen_width / 2),
                             ...
                             libtcod.CENTER, 'ROGUELIKE NEVER BEFORE!')
...
def level_up_menu(con, header, player, menu_width, screen_width,
                  screen_height):
    options = [
...
def character_screen(player, character_screen_width, character_screen_height,
    ...
    libtcod.console_print_rect_ex(
        ...
        libtcod.BKGND_NONE, libtcod.LEFT, 'Experience to level: {0}'.format(
